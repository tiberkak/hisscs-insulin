...
work out well, though the GL may be the one to prefer as it addresses some weaknesses of the GI.
...
slowly (see
\url{http://web.mit.edu/athletics/sportsmedicine/wcrglycemicindex.html}).
